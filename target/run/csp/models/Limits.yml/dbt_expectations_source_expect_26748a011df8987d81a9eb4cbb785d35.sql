select
    ...
    from (
      with relation_columns as (
        ...
        select
            cast('_CHANGEDFIELDS' as STRING) as relation_column,
            cast('STRING' as STRING) as relation_column_type
        union all
        ...
        select
            cast('VALIDATION_REASON' as STRING) as relation_column,
            cast('STRING' as STRING) as relation_column_type
        union all
        
        select
            cast('VALIDATION_STATUS' as STRING) as relation_column,
            cast('STRING' as STRING) as relation_column_type
